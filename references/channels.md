...
Install plugins: `openclaw plugins install <plugin-name>`
...
Manage pairings:
```bash
openclaw pairing list --channel <name>
...
When adding a non-default account, OpenClaw auto-migrates to multi-account structure.
