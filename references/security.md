...
Security rule: never store passwords, tokens, recovery emails, or 2FA secrets in skill files, repo files, or logs.
...
openclaw channels logout --channel <name>      # Logout channels
```
